...
const FEATURES = [
  {
    title: "Track All Your Cards in One Place",
    description: "Keep track of all your credit cards, their balances, and payment due dates. Never miss a payment again.",
    icon: "📱"
  },
  {
  ...
  },
  {
    ...
    description: "Get timely notifications before your payment due dates. Stay on top of your finances effortlessly.",
    icon: "🔔"
  }
];
        ...
        <header style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Your Personal Credit Card Dashboard
            </p>
        ...
        <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 24px" }}>
          <div style={{ marginBottom: "80px", textAlign: "center" }}>
            ...
            <div style={{
              width: "80px",
              height: "4px",
              background: "linear-gradient(90deg, #007AFF 0%, #00BFFF 100%)",
              margin: "0 auto",
              borderRadius: "2px"
            }} />
          </div>
