export default function WalnutPrivacyPolicy() {
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", lineHeight: "1.6", maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      <p>Mayank Gandhi ("we," "us," or "our") operates the Health Stack iOS application ("App"). This Privacy Policy explains our approach to your information when you use our App.</p>
      <p>We are committed to protecting your privacy and ensuring the security of your health information. All your health data remains stored locally on your device only. We do not collect, transmit, or store any of your personal information or usage data on our servers.</p>
      ...
      <h3>2.1 Health Information You Provide</h3>
      <ul>
        <li><strong>Manual Entries:</strong> Health data you manually input into the App</li>
        <li><strong>Uploaded Documents:</strong> Health documents you choose to upload for processing</li>
        <li><strong>Extracted Data:</strong> Health information extracted from your uploaded documents</li>
      </ul>
      <p><strong>Important:</strong> All health data is stored exclusively on your device. We never collect, store, access, or retain your health information on our servers.</p>
      ...
      <ul>
        <li><strong>Notifications:</strong> To send health reminders locally on your device</li>
        <li><strong>Alarm Kit:</strong> To set medication and health tracking alerts locally on your device</li>
      </ul>
      <p>We do not transmit or collect any data from these permissions.</p>

      <h2>3. HOW WE USE YOUR INFORMATION</h2>

      <h3>3.1 Health Data Processing</h3>
      <ul>
        <li><strong>No Server Storage:</strong> We do not retain copies of your health documents or extracted data on our servers</li>
        <li><strong>Local Storage Only:</strong> All health data remains on your device under your complete control</li>
      </ul>
      ...
      <ul>
        <li>Store and organize your health data</li>
      ...
      <ul>
        <li><strong>Device-Only Storage:</strong> Your health data is stored exclusively on your device</li>
        ...
        <li><strong>No Remote Access:</strong> We cannot access, view, or retrieve your health data</li>
      </ul>

      <h3>4.2 Security Measures</h3>
      <ul>
        <li><strong>Encrypted Storage:</strong> All health data is encrypted at rest on your device using iOS security</li>
      ...
      <p>We will never sell, rent, or share your health information with:</p>
      <ul>
        <li>Advertisers</li>
        <li>Data brokers</li>
      ...
      <p><strong>Note:</strong> Because your health data is stored only on your device, we cannot disclose what we do not have access to. We have no access to your health information.</p>

      <h2>6. DATA RETENTION</h2>

      <h3>6.1 Health Data</h3>
      <ul>
      ...
      <ul>
        <li>Access all your health data within the App</li>
      ...
      <ul>
        <li>iOS Settings &gt; Health Stack &gt; Permissions</li>
      ...
      <p><strong>Important:</strong> Because your health data is stored exclusively on your device, any breach of our systems would not expose your health information.</p>
      ...
      <h2>14. HEALTH DATA SPECIAL CONSIDERATIONS</h2>

      <h3>14.1 Sensitive Information</h3>
      <p>We recognize health data as particularly sensitive and:</p>
      <ul>
        ...
        <li>Never use health data for advertising, profiling, or marketing</li>
        <li>Never store health data on our servers or any cloud services</li>
      </ul>

      <h3>14.2 Compliance</h3>
      <p>We strive to comply with applicable health data regulations including:</p>
      <ul>
        <li>HIPAA (where applicable)</li>
        <li>State health information privacy laws</li>
        <li>International health data protection standards</li>
      </ul>

      <h3>14.3 On-Device Security</h3>
      <ul>
        <li>Your health data never leaves your device except when you explicitly choose to process documents</li>
        <li>Processed documents are not retained by us or our service providers</li>
        <li>All health information remains under your complete control</li>
        <li>Only you can access your health data through your device</li>
      </ul>
      ...
      <p><em>By using the Health Stack App, you acknowledge that you have read and understood this Privacy Policy and agree to its terms. Your health data is stored exclusively on your device, ensuring maximum privacy and security.</em></p>
    </div>
  );
}
